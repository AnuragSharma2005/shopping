...
export default function Navbar({ title, isAuthenticated }) {
  ...
  return (
    <div className="w-full shadow sticky top-0 z-50 bg-white">
      ...
      {/* Mobile Search + Icons in same row */}
      <div className="md:hidden flex items-center gap-3 px-4 py-2 bg-white shadow">
        {/* Search */}
        ...
        {isAuthenticated ? (
          ...
          <Link to="/auth/login">
            <div className="w-9 h-8 bg-blue-500 rounded-full flex items-center justify-center shadow hover:bg-blue-600 transition duration-200">
