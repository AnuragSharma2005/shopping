...
export default function Wcare() {
  ...
  const { products, loading, error } = useProducts("wcare");
  ...
  <h2 className="text-xl font-bold mb-4">wcare Products</h2>
  {loading ? (
