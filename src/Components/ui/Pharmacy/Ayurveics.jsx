...
export default function Ayurveics() {
  ...
  const { products, loading, error } = useProducts("ayurveics");
  ...
  <h2 className="text-xl font-bold mb-4">Ayurvedic Products</h2>
  {loading ? (
