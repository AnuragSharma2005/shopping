...
export default function MFormal() {
  ...
  const { products, loading, error } = useProducts("mformal");
  ...
  <h2 className="text-xl font-bold mb-4">Formal Products</h2>
  {loading ? (
