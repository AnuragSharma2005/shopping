...
export default function Wformals() {
  ...
  const { products, loading, error } = useProducts("wformals");
  ...
  <h2 className="text-xl font-bold mb-4">women formal Products</h2>
  {loading ? (
