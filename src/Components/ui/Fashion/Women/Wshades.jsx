...
export default function Wshades() {
  ...
  const { products, loading, error } = useProducts("wshades");
  ...
  <h2 className="text-xl font-bold mb-4">Women shades Products</h2>
  {loading ? (
