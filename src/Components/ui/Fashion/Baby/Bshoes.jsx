...
export default function Bshoes() {
  ...
  const { products, loading, error } = useProducts("bshoes");
  ...
  <h2 className="text-xl font-bold mb-4">baby shoes Products</h2>
  {loading ? (
